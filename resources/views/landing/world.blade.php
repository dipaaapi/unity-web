    ...
    <div class="inner-row2">
        <div class="inner-sub-row2">
            ...
            <div class="md:my-4 my-5 w-10/12 md:w-2/3 mx-auto">
                <p class="text-white text-left text-sm md:text-lg">Unity is a 2D & 3D game engine that has been around since 2005. Founded and launched by Unity Technologies, and is well known as one of the high-end game engines.</p>
            </div>
